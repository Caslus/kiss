...
For all available fields and options, including required fields like `id` and `displayName`, please refer to the **[configuration reference](/reference/configuration)**.